...
//               <h3 className='fw-bolder mt-3'>A comprehensive and<br /> user-friendly platform</h3>
//               <p className='mt-2'>Lorem ipsum dolor sit amet, consectetur<br /> adipiscing elit, sed do eiusmod tempor
//                  incididunt<br /> ut labore Lorem ipsum dolor sit amet, consectetur </p>
//                  <Button className='mt-3 text-white' style={{ background: "#F8CA25", border: "none" }}>
//   Learn More {' '}
//   <span className='fw-bolder ' style={{ fontSize: '20px', letterSpacing: '-1px', fontWeight: 'bold' }}>&rarr;</span>
// </Button>
...
//           </Col>
//           <Col md={6}>
//             <img src={secondsection} alt="" className="w-100 mt-5" /> 
//           </Col>
//         </Row>
//       </Container>
//     </section>
...
const Hero = () => {
  ...
  return (
    <section className='hero'>
      ...
      Welcome to <span className="animated-bg">The Catalyst,</span> <br />
      where innovation<br />
      meets investment.
    </h1>
      ...
      <p className='mt-3 slide-in-right ' style={{ color: '#6B7588' }}>
        We are dedicated to fueling the growth of promising startups and driving
        <br className='d-none d-sm-block' />
        forward groundbreaking ideas. With our deep expertise and extensive
        <br className='d-none d-sm-block' />
        network, we empower entrepreneurs to make their visions a reality.
      </p>
  ...
  <Row className="align-items-center custom-row">
    <Col xs={12} sm={12} md={4} className="mb-0">
      ...
      <p className="mb-0 fw-bolder" style={{ fontSize: '12px' }}>Amount Raised</p>
    </Col>
    ...
    <Col xs={12} sm={12} md={2} className="mb-0">
      ...
      <p className="mb-0 fw-bolder" style={{ fontSize: '12px' }}>Minimum</p>
    </Col>
    ...
    <Col xs={12} sm={12} md={4} className="mb-0">
      ...
      <p className="mb-0 fw-bolder" style={{ fontSize: '12px' }}>Valuation Cap</p>
    </Col>
  </Row>
</div>
