...
function MyForm() {
  ...
  return (
    <>
      <Container className="mt-5 justify-content-center align-items-center" style={{ maxWidth: '540px', height:'100vh' }}>
        <div className='text-center' style={{ marginTop: "140px" }}>
          <h4 className='fw-bolder'>Reset Email Address</h4>
        </div>
        <Card className="p-4" style={{ border: 'none', boxShadow: 'none' }}>
          <Form onSubmit={handleSubmit}>
            <Row className="mb-4">
              <Col xs={12} md={12}>
                <div className=''>
                  <Form.Label className='text-black fw-bold'>New Email Address</Form.Label>
                  <Form.Control
                    type="email"
